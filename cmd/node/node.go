...
func (s *kvServer) Get(ctx context.Context, in *pb.GetRequest) (*pb.GetResponse, error) {
	...
	return &pb.GetResponse{Value: fmt.Sprintf("Get response from replica %d of node %d. Key %s is stored at %s.", *replica, *node, key, member)}, nil
}
...
func (s *kvServer) Put(ctx context.Context, in *pb.PutRequest) (*pb.PutResponse, error) {
	...
	return &pb.PutResponse{
		Message: fmt.Sprintf("Put response from replica %d of node %d. Key %s is stored at %s", *replica, *node, key, member),
	}, nil
}
...
func (s *kvServer) Delete(ctx context.Context, in *pb.DeleteRequest) (*pb.DeleteResponse, error) {
	...
	return &pb.DeleteResponse{
		Message: fmt.Sprintf("Delete response from replica %d of node %d. Key %s is stored at %s", *replica, *node, key, member),
	}, nil
}
